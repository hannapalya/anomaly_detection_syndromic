...
\item Hutwagner, L., Thompson, W., Seeman, G.\ M., \& Treadwell, T.\ (2003). The bioterrorism preparedness and response Early Aberration Reporting System (EARS). \textit{Journal of Urban Health}, 80(2 Suppl 1), i89--i96.

\item Morbey, R.\ A., Elliot, A.\ J., Charlett, A., Verlander, N.\ Q., Andrews, N., \& Smith, G.\ E.\ (2015). The application of a novel ``rising activity, multi-level mixed effects, indicator emphasis'' (RAMMIE) method for syndromic surveillance in England. \textit{Bioinformatics}, 31(22), 3660--3665.
