...
\paragraph{BOCPD-residual.} Bayesian Online Changepoint Detection, following the framework of \citet{adams2007}, is applied to the Pearson residuals under a Gaussian approximation. The anomaly score combines the negative log-likelihood under the current baseline with the posterior probability that the current run length is zero (i.e., a changepoint has just occurred).
